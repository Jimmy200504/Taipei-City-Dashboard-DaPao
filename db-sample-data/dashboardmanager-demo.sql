...
1	ev_charging_stations_tpe	充電站	circle	api	\N	\N	{"circle-color":"#4CAF50","circle-radius":6,"circle-stroke-width":1.5,"circle-stroke-color":"#fff","circle-opacity":0.9}	[{"key":"station_name","name":"站名"},{"key":"spaces","name":"充電車位數"},{"key":"charging_point_count","name":"充電樁數"},{"key":"connector_count","name":"充電槍數"},{"key":"service_time","name":"服務時間"},{"key":"parking_rate","name":"停車費率"},{"key":"charging_rate","name":"充電費率"},{"key":"power_summary","name":"充電槍功率摘要"},{"key":"data_time","name":"資料時間"}]
2	ev_charging_stations_metrotaipei	充電站	circle	api	\N	\N	{"circle-color":"#4CAF50","circle-radius":6,"circle-stroke-width":1.5,"circle-stroke-color":"#fff","circle-opacity":0.9}	[{"key":"station_name","name":"站名"},{"key":"spaces","name":"充電車位數"},{"key":"charging_point_count","name":"充電樁數"},{"key":"connector_count","name":"充電槍數"},{"key":"service_time","name":"服務時間"},{"key":"parking_rate","name":"停車費率"},{"key":"charging_rate","name":"充電費率"},{"key":"power_summary","name":"充電槍功率摘要"},{"key":"data_time","name":"資料時間"}]
\.
...
1	ev_charging_district_stations	行政區充電站數量
2	ev_charging_district_points	行政區充電樁數量
3	ev_charging_connector_power	充電槍功率比例
\.
...
3	TtouTsai	TtouTsai	https://github.com/TtouTsai.png	https://github.com/TtouTsai	\N	\N	f	2026-05-02 19:01:30.596418+00	2026-05-02 19:01:30.596418+00
\.
...
361	ev_charging_tpe	汽車充電	{1,2,3}	electric_car	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00
362	ev_charging_newtpe	汽車充電	{1,2,3}	electric_car	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00
...
ev_charging_district_stations	\N	{1}	{}	static	\N	1	week	環保署／交通部	顯示臺北市各行政區電動車充電站數量分布	顯示臺北市與新北市各行政區的電動汽車充電站總數分布，資料來自交通部 TDX CityEVCharging API，整合中央目的事業主管機關公開之充電站位置與營運資訊，每日更新。	透過本組件可以掌握雙北充電站於各行政區的布建密度與整體均衡度，辨識仍須加強的區域，作為雙北政府協同推動電動運具普及、加速汰換燃油車輛、降低都會區交通溫室氣體排放的參考依據，攜手實踐淨零城市願景。	{https://tdx.transportdata.tw/api-service/swagger/basic/b378d320-04a9-4fba-80b8-0df1b96dd5e8#/CityEVCharging/ParkingEV_API_Connector}	{TtouTsai}	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00	two_d	SELECT district AS x_axis, station_count AS data\n   FROM env_ev_charging_district_summary\n   WHERE city_scope = 'taipei'\n   ORDER BY district	\N	taipei
ev_charging_district_stations	\N	{2}	{}	static	\N	1	week	環保署／交通部	顯示雙北各行政區電動車充電站數量分布	顯示臺北市與新北市各行政區的電動汽車充電站總數分布，資料來自交通部 TDX CityEVCharging API，整合中央目的事業主管機關公開之充電站位置與營運資訊，每日更新。	透過本組件可以掌握雙北充電站於各行政區的布建密度與整體均衡度，辨識仍須加強的區域，作為雙北政府協同推動電動運具普及、加速汰換燃油車輛、降低都會區交通溫室氣體排放的參考依據，攜手實踐淨零城市願景。	{https://tdx.transportdata.tw/api-service/swagger/basic/b378d320-04a9-4fba-80b8-0df1b96dd5e8#/CityEVCharging/ParkingEV_API_Connector}	{TtouTsai}	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00	two_d	SELECT district AS x_axis, station_count AS data\n   FROM env_ev_charging_district_summary\n   WHERE city_scope = 'twin_city'\n   ORDER BY district	\N	metrotaipei
ev_charging_district_points	\N	{}	{}	static	\N	1	week	環保署／交通部	顯示臺北市各行政區電動車充電樁數量分布	顯示臺北市與新北市各行政區的電動汽車充電樁總數分布。充電樁是每座充電站可同時供電的設備數，相較於充電站數量更能反映實際充電服務量能。資料來自交通部 TDX CityEVCharging API 之 ChargingPoint 資料集，每日更新。	透過本組件可以了解雙北各行政區實際可同時服務電動車的容量分布，辨識熱門區位是否需要擴建樁位以避免排隊與里程焦慮，鼓勵更多市民安心改用電動車，從源頭降低交通部門碳排與都會區空氣污染，加速綠色運輸轉型。	{https://tdx.transportdata.tw/api-service/swagger/basic/b378d320-04a9-4fba-80b8-0df1b96dd5e8#/CityEVCharging/ParkingEV_API_Connector}	{TtouTsai}	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00	two_d	SELECT district AS x_axis, charging_point_count AS data\n   FROM env_ev_charging_district_summary\n   WHERE city_scope = 'taipei'\n   ORDER BY district	\N	taipei
ev_charging_district_points	\N	{}	{}	static	\N	1	week	環保署／交通部	顯示雙北各行政區電動車充電樁數量分布	顯示臺北市與新北市各行政區的電動汽車充電樁總數分布。充電樁是每座充電站可同時供電的設備數，相較於充電站數量更能反映實際充電服務量能。資料來自交通部 TDX CityEVCharging API 之 ChargingPoint 資料集，每日更新。	透過本組件可以了解雙北各行政區實際可同時服務電動車的容量分布，辨識熱門區位是否需要擴建樁位以避免排隊與里程焦慮，鼓勵更多市民安心改用電動車，從源頭降低交通部門碳排與都會區空氣污染，加速綠色運輸轉型。	{https://tdx.transportdata.tw/api-service/swagger/basic/b378d320-04a9-4fba-80b8-0df1b96dd5e8#/CityEVCharging/ParkingEV_API_Connector}	{TtouTsai}	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00	two_d	SELECT district AS x_axis, charging_point_count AS data\n   FROM env_ev_charging_district_summary\n   WHERE city_scope = 'twin_city'\n   ORDER BY district	\N	metrotaipei
ev_charging_connector_power	\N	{}	{}	static	\N	1	week	環保署／交通部	顯示臺北市各行政區充電槍功率級距比例	顯示臺北市與新北市各行政區「充電槍」（連接器）的功率級距分布比例，分為慢充（AC）、中速快充（DC 22-50 kW）、快充（DC 50-150 kW）、急速快充（DC ≥150 kW）四級。資料來自交通部 TDX CityEVCharging API 之 Connector 資料集，每日更新。	透過本組件可以比較雙北各行政區的快充覆蓋率，辨識仍以慢充為主、缺乏高功率充電服務的區域，作為政府引導業者布建快充樁、規劃跨市長程移動快充走廊的參考，協助縮短電動車充電等待時間、提升使用者體驗，進一步加速燃油車汰換與運輸部門減碳進程。	{https://tdx.transportdata.tw/api-service/swagger/basic/b378d320-04a9-4fba-80b8-0df1b96dd5e8#/CityEVCharging/ParkingEV_API_Connector}	{TtouTsai}	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00	three_d	SELECT s.district AS x_axis,\n       CASE s.power_bucket\n         WHEN 'slow_ac' THEN '0-22kW'\n         WHEN 'medium_dc' THEN '22-50kW'\n         WHEN 'fast_dc' THEN '50-150kW'\n         WHEN 'ultra_fast_dc' THEN '150kW以上'\n       END AS y_axis,\n       s.connector_count AS data\n  FROM env_ev_charging_connector_power_district s\n  JOIN (\n    SELECT district,\n           SUM(CASE WHEN power_bucket IN ('medium_dc','fast_dc','ultra_fast_dc') THEN connector_count ELSE 0 END)::float\n           / NULLIF(SUM(CASE WHEN power_bucket <> 'unknown' THEN connector_count ELSE 0 END), 0) AS fast_ratio\n      FROM env_ev_charging_connector_power_district\n     WHERE city_scope = 'taipei'\n     GROUP BY district\n  ) r ON r.district = s.district\n WHERE s.city_scope = 'taipei'\n   AND s.power_bucket <> 'unknown'\n ORDER BY r.fast_ratio DESC NULLS LAST, s.district, s.power_bucket_order	\N	taipei
ev_charging_connector_power	\N	{}	{}	static	\N	1	week	環保署／交通部	顯示雙北各行政區充電槍功率級距比例	顯示臺北市與新北市各行政區「充電槍」（連接器）的功率級距分布比例，分為慢充（AC）、中速快充（DC 22-50 kW）、快充（DC 50-150 kW）、急速快充（DC ≥150 kW）四級。資料來自交通部 TDX CityEVCharging API 之 Connector 資料集，每日更新。	透過本組件可以比較雙北各行政區的快充覆蓋率，辨識仍以慢充為主、缺乏高功率充電服務的區域，作為政府引導業者布建快充樁、規劃跨市長程移動快充走廊的參考，協助縮短電動車充電等待時間、提升使用者體驗，進一步加速燃油車汰換與運輸部門減碳進程。	{https://tdx.transportdata.tw/api-service/swagger/basic/b378d320-04a9-4fba-80b8-0df1b96dd5e8#/CityEVCharging/ParkingEV_API_Connector}	{TtouTsai}	2026-05-02 16:27:57.829836+00	2026-05-02 16:27:57.829836+00	three_d	SELECT s.district AS x_axis,\n       CASE s.power_bucket\n         WHEN 'slow_ac' THEN '0-22kW'\n         WHEN 'medium_dc' THEN '22-50kW'\n         WHEN 'fast_dc' THEN '50-150kW'\n         WHEN 'ultra_fast_dc' THEN '150kW以上'\n       END AS y_axis,\n       s.connector_count AS data\n  FROM env_ev_charging_connector_power_district s\n  JOIN (\n    SELECT district,\n           SUM(CASE WHEN power_bucket IN ('medium_dc','fast_dc','ultra_fast_dc') THEN connector_count ELSE 0 END)::float\n           / NULLIF(SUM(CASE WHEN power_bucket <> 'unknown' THEN connector_count ELSE 0 END), 0) AS fast_ratio\n      FROM env_ev_charging_connector_power_district\n     WHERE city_scope = 'twin_city'\n     GROUP BY district\n  ) r ON r.district = s.district\n WHERE s.city_scope = 'twin_city'\n   AND s.power_bucket <> 'unknown'\n ORDER BY r.fast_ratio DESC NULLS LAST, s.district, s.power_bucket_order	\N	metrotaipei
\.
